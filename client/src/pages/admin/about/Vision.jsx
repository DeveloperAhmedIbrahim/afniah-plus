...
const AboutVision = () => {
    ...
    // Fetch about vision data - ab language change per bhi refresh hoga
    useEffect(() => {
        const fetchAboutVision = async () => {
            ...
            try {
                ...
                toast.error('Failed to load about vision data');
            } finally {
    ...
    if (!vision) {
        return (
            <div className="flex items-center justify-center min-h-screen">
                <p className="text-red-500">About vision data not found</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6">
            ...
            <h1 className={`text-2xl text-gray-600 flex items-center gap-2`}>
                ...
                Vision {isArabic ? <ChevronLeftIcon className="w-5 h-5" /> : <ChevronRightIcon className="w-5 h-5" />} 
                    ...
                    <form className="space-y-8" onSubmit={onSubmit}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className={isArabic ? 'text-right' : 'text-left'}>
                                ...
                                <Input
                                    ...
                                    key={`title-${lang}-${vision?.title}`}
                                    placeholder={isArabic ? 'عنوان المشروع' : 'About Vision Title'}
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-1'>
                            ...
                            <div className={isArabic ? 'text-right' : 'text-left'}>
                                ...
                                <Textarea
                                    ...
                                    key={`description-${lang}-${vision?.description}`}
                        ...
                        <Button type="submit" className="w-full" disabled={loading}>
                            {loading ? (
                                ...
                                isArabic ? 'تحديث المشروع' : 'Update About Vision'
                            )}
                        </Button>
                    </form>
                </CardContent>
